...
def run_datasets(dataset_list):
    ...
    if 0 in dataset_list:
        asvspoof = ASVspoof2015(**extraction_params, object_path=r'D:\Thesis_Results\Data_Readers\ASVspoof2015_{}')
    ...
    if 1 in dataset_list:
        chenaudio = ChenAudiosetDataset(**extraction_params,
                                        object_path=r'D:\Thesis_Results\Data_Readers\ChenAudiosetDataset')
    ...
    if 2 in dataset_list:
        dcaseScene = DCASE2017_SS(**extraction_params, object_path=r'D:\Thesis_Results\Data_Readers\DCASE2017_SS_{}')
    ...
    if 3 in dataset_list:
        fsdkaggle = FSDKaggle2018(**extraction_params, object_path=r'D:\Thesis_Results\Data_Readers\FSDKaggle2018')
    ...
    if 4 in dataset_list:
        ravdess = Ravdess(**extraction_params, object_path=r'D:\Thesis_Results\Data_Readers\Ravdess')
    ...
    if 5 in dataset_list:
        speechcommands = SpeechCommands(**extraction_params,
                                        object_path=r'D:\Thesis_Results\Data_Readers\SpeechCommands_{}')
