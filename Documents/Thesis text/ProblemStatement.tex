...
\begin{itemize}
	...
	\item \textbf{Comprehensible:} New developers using the framework should get a clear development structure and guiding through examples, warnings and hints.
