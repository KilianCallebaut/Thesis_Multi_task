...
%
%To simplify the process of generating concatenated train and test sets combined from various datasets, the system has an abstraction to this process, through the \textbf{TrainingSetCreator}. The TrainingSetCreator 
%
